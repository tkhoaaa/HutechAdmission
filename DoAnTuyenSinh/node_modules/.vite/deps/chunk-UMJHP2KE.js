...
function usePopupAutoResize(parameters) {
  ...
  const committedDimensionsRef = React2.useRef(null);
  const liveDimensionsRef = React2.useRef(null);
  const isInitialRenderRef = React2.useRef(true);
  const restoreAnchoringStylesRef = React2.useRef(NOOP);
  const onMeasureLayout = useStableCallback(onMeasureLayoutParam);
  const onMeasureLayoutComplete = useStableCallback(onMeasureLayoutCompleteParam);
  const anchoringStyles = React2.useMemo(() => {
...
function usePopupViewport(parameters) {
  ...
  if (!isTransitioning) {
    ...
    childrenToRender = (0, import_jsx_runtime2.jsxs)(React4.Fragment, {
...
//# sourceMappingURL=chunk-UMJHP2KE.js.map
